...
import io.aiven.kafka.tieredstorage.core.manifest.index.serde.TransformedChunksDeserializer;
import io.aiven.kafka.tieredstorage.core.manifest.index.serde.TransformedChunksSerializer;
