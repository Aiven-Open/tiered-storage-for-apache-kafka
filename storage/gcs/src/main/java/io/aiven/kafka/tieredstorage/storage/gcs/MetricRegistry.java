...
public class MetricRegistry {
    ...
    static final MetricNameTemplate OBJECT_METADATA_GET_RATE_METRIC_NAME =
        new MetricNameTemplate(OBJECT_METADATA_GET_RATE, METRIC_GROUP, "");
    static final MetricNameTemplate OBJECT_METADATA_GET_TOTAL_METRIC_NAME =
        new MetricNameTemplate(OBJECT_METADATA_GET_TOTAL, METRIC_GROUP, "");
    static final MetricNameTemplate OBJECT_GET_RATE_METRIC_NAME =
        new MetricNameTemplate(OBJECT_GET_RATE, METRIC_GROUP, "");
    static final MetricNameTemplate OBJECT_GET_TOTAL_METRIC_NAME =
        new MetricNameTemplate(OBJECT_GET_TOTAL, METRIC_GROUP, "");
    static final MetricNameTemplate OBJECT_DELETE_RATE_METRIC_NAME =
        new MetricNameTemplate(OBJECT_DELETE_RATE, METRIC_GROUP, "");
    static final MetricNameTemplate OBJECT_DELETE_TOTAL_METRIC_NAME =
        new MetricNameTemplate(OBJECT_DELETE_TOTAL, METRIC_GROUP, "");
    static final MetricNameTemplate RESUMABLE_UPLOAD_INITIATE_RATE_METRIC_NAME =
        new MetricNameTemplate(RESUMABLE_UPLOAD_INITIATE_RATE, METRIC_GROUP, "");
    static final MetricNameTemplate RESUMABLE_UPLOAD_INITIATE_TOTAL_METRIC_NAME =
        new MetricNameTemplate(RESUMABLE_UPLOAD_INITIATE_TOTAL, METRIC_GROUP, "");
    static final MetricNameTemplate RESUMABLE_CHUNK_UPLOAD_RATE_METRIC_NAME =
        new MetricNameTemplate(RESUMABLE_CHUNK_UPLOAD_RATE, METRIC_GROUP, "");
    static final MetricNameTemplate RESUMABLE_CHUNK_UPLOAD_TOTAL_METRIC_NAME =
        new MetricNameTemplate(RESUMABLE_CHUNK_UPLOAD_TOTAL, METRIC_GROUP, "");
